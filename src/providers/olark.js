...
Olark.prototype.initialize = function (settings) {
...
Olark.prototype.identify = function (userId, traits) {
  if (!this.settings.identify) return;
...
Olark.prototype.track = function (event, properties) {
...
Olark.prototype.pageview = function () {
