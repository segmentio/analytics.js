...
function Analytics () {
  ...
  bind.methods(this, 'init', 'initialize', 'identify', 'user', 'group', 'track',
  'trackClick', 'trackLink', 'trackSubmit', 'trackForm', 'pageview', 'alias',
  'ready', '_options', '_callback', '_invoke', '_parseQuery');
}
