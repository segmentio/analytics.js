...
module.exports = {
    ...
    'bloomreach': require('@astronomerio/analytics.js-integration-bloomreach'),
    'blueshift': require('@astronomerio/analytics.js-integration-blueshift'),
    'criteo': require('@astronomerio/analytics.js-integration-criteo'),
    'doubleclick': require('@astronomerio/analytics.js-integration-doubleclick'),
