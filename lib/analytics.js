...
/**
 * Define a new `Provider`, or get an existing provider.
 *
...
exports.provider = function (Provider) {
  if (is.string(Provider)) return Providers[Provider];
...
Analytics.prototype.initialize = function (settings, options) {
  ...
  each(settings, function (name, options) {
    ...
    self._integrations[name] = provider;
  });
...
Analytics.prototype._invoke = function (method, args) {
  ...
  each(this._integrations, function (name, provider) {
